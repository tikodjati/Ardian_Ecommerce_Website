    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-4 lg:gap-6">
                <button class="hidden md:block text-sm font-medium nav-text transition-colors duration-300 cursor-pointer">Call Us</button>
                ...
                <button class="nav-text transition-colors duration-300 cursor-pointer">
...
<div id="unified-menu" 
     class="fixed inset-0 z-[60] flex flex-col md:flex-row transform -translate-x-full transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] font-jost pointer-events-none"
     style="top: 0; padding-top: 0;">
    
    <div class="w-full md:w-[25%] lg:w-[20%] h-full border-r border-gray-100 bg-white z-30 flex flex-col pointer-events-auto shadow-xl">
        ...
        <div class="flex-1 overflow-y-auto px-8 pb-20 pt-6">
            ...
            <div class="mb-10">
                ...
                <nav class="flex flex-col gap-1">
                    ...
                    <a href="#" class="block py-3 text-[15px] text-gray-900 hover:text-gray-600">Accessories</a>
                </nav>
            </div>
    ...
    <div id="col-level-2" class="w-full md:w-[30%] lg:w-[25%] h-full border-r border-gray-100 bg-white z-20 overflow-y-auto hidden pointer-events-auto shadow-xl">
        <div class="h-full flex flex-col px-10 pt-24 animate-fade-in">
    ...
    <div id="col-level-3" class="w-full md:w-[45%] lg:w-[55%] h-full bg-white z-10 overflow-y-auto p-8 pt-24 hidden pointer-events-auto shadow-xl">
