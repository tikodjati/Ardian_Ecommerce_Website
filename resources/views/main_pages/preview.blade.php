<div class="bg-white">
  <div class="mx-auto max-w-full px-6 py-12 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8 lg:py-20">
    <!-- Header Section -->
    <div class="text-center mb-3 sm:mb-12 lg:mb-16">
      <h2 class="text-xl sm:text-1xl lg:text-2xl font-light tracking-wider text-gray-900 mb-1">
